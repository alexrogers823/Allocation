export const accountsData = [
  { name: 'Rent', cost: 1300, priority: 'base', link: 'https://www.ally.com/'},
  ...
  { name: 'Phone Bill', cost: 80, priority: 'primary' },
  { name: 'Motorcycle Insurance', cost: 16, priority: 'primary' },
  { name: 'Voiceover', cost: 100, priority: 'secondary' },
  { name: 'Flights', cost: 30, priority: 'secondary' },
  { name: 'Travel', cost: 70, priority: 'secondary' },
  { name: 'Investments', percent: 0.6, priority: 'tertiary' },
  { name: 'Car', percent: 0.3, priority: 'tertiary' },
  { name: 'Short Term Expenses', percent: 0.1, priority: 'tertiary' }
]